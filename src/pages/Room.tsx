...
export function Room() {
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        if (newQuestion.trim() === '') {
            toast.error("Primeiro escereva sua pergunta", {duration: 3000})
            return;
        }
        ...
        if (key){
            setNewQuestion('')
            toast.success("Pergunta enciada com sucesso", {duration: 3000})
        }
        else{
            toast.error("Não foi possivel enciar a pergunta", {duration: 3000})
        }
